...
<div class="form-group col-md-6 col-sm-6 col-xs-12">
    ...
    <input type="text" class="form-control" id="pt_email" name="pt_email" placeholder="example@email.com" value="<?php echo isset($post['pt_email']) ? htmlspecialchars($post['pt_email']) : '' ?>"
           data-rule-required="true"  data-msg-required="<?php _tr('Required info') ?>"
