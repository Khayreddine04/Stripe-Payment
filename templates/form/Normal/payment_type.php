...
$enable_paypal = isset($enable_paypal) ? $enable_paypal : 'n';
$buttons_enable = isset($buttons_enable) ? $buttons_enable : 'n';
$paypal_merchant = isset($paypal_merchant) ? $paypal_merchant : '';
$post = isset($post) ? $post : [];

if(($enable_paypal=='y' && !empty($paypal_merchant)) || $buttons_enable=='y'){ 
?>
